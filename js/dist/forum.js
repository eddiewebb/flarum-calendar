...
app.initializers.add('webbinaro-calendar', function () {
  ...
  app.store.models.events = _Models_Event__WEBPACK_IMPORTED_MODULE_6__["default"];
  app.store.models.users.prototype.canModerateEvents = flarum_Model__WEBPACK_IMPORTED_MODULE_7___default.a.attribute('canModerateEvents');
  app.store.models.users.prototype.canStartEvents = flarum_Model__WEBPACK_IMPORTED_MODULE_7___default.a.attribute('canStartEvents');
  app.store.models.users.prototype.canViewEvents = flarum_Model__WEBPACK_IMPORTED_MODULE_7___default.a.attribute('canViewEvents'); //add events to side nav

  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_3__["extend"])(flarum_components_IndexPage__WEBPACK_IMPORTED_MODULE_4___default.a.prototype, 'navItems', function (items) {
