const libs = {
	...
	fullcalendarDayGrid: {
		...
		loaded: () =>
			...
			FullCalendar.globalPlugins.find((p) => p.name === '@fullcalendar/daygrid'),
	},
	fullcalendarInteraction: {
		js: 'https://cdn.jsdelivr.net/npm/@fullcalendar/interaction@6.1.7/index.global.min.js',
		loaded: () =>
			typeof FullCalendar !== 'undefined' &&
			FullCalendar.globalPlugins.find((p) => p.name === '@fullcalendar/interaction'),
	},
	fullcalendarList: {
		js: 'https://cdn.jsdelivr.net/npm/@fullcalendar/list@6.1.7/index.global.min.js',
		loaded: () =>
			typeof FullCalendar !== 'undefined' &&
			FullCalendar.globalPlugins.find((p) => p.name === '@fullcalendar/list'),
	},
